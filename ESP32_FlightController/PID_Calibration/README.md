...
| :--- | :--- | :--- | :--- |
| **Baseline Test** | Kp=0.5, Ki=0, Kd=0 | Low sensitivity. The drone reacts slowly to tilt and struggles to stay level. | [Watch Video](YOUR_LINK_HERE) |
| **Stability Iteration** | Kp=1.1, Ki=0.5, Kd=0 | Improved responsiveness, but suffers from "overshoot" and oscillations due to lack of damping. | [Watch Video](YOUR_LINK_HERE) |
| **Final Calibration** | **Kp=1.1, Ki=0.45, Kd=0.003** | **Optimal balance. The D-term provides necessary damping, resulting in a stable and smooth hover.** | [Watch Video](YOUR_LINK_HERE) |
